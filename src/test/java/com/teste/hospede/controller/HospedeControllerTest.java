...
class HospedeControllerTest {
	...
	@Test
	@DisplayName("Test de buscar hospede por id")
	...
	@Test
	@DisplayName("Teste de deleção de hóspede")
	void testDeletarHospede() {
		...
		assertEquals(HttpStatus.NOT_FOUND, checkDeleted.getStatusCode(), "Após o DELETE o hóspede não deveroa ser encontrado.");
	}
}
